...
const WerewolfTemplate = {
    "CHANNEL_LG": {
        "หมวดหมู่" : "• ปาร์ตี้หมาป่า •",
        "ชาวบ้าน" : "・ชาวบ้าน",
        "กามเทพ": "・กามเทพ", 
        "ผู้มีลาง": "・ผู้มีลาง", 
        "ผู้หยั่งรู้": "・ผู้หยั่งรู้", 
    ...
    "WIN_LG": {
        "เสมอ" : {
            "title": "⚖️ • เสมอกัน" , 
            "desc": "ไม่มีใครชนะในเกมนี้.", 
            "Winner": 0
        },

        "คู่รัก" : {
            "title": "♥ • คู่รักชนะ" , 
            "desc": "ในเกมนี้คู่รักเป็นผู้ชนะ.", 
            "Winner": "du __couple__"
        },

        "ฝ่ายชาวบ้าน" : {
            "title": "🏘 • ฝ่ายชาวบ้านชนะ" , 
            "desc": "ในเกมนี้ฝ่ายชาวบ้านเป็นผู้ชนะ.", 
            "Winner": "du __village__"
        },

        "ฝ่ายหมาป่า" : {
            "title": "🐺 • ฝ่ายหมาป่าชนะ" , 
            "desc": "ในเกมนี้ฝ่ายหมาป่าเป็นผู้ชนะ.", 
            "Winner": "des __loups__"
        },

        "คนติดยา" : {
            "title": "🚬 • คนติดยาชนะ" , 
            "desc": "ในเกมนี้คนติดยาเป็นผู้ชนะ.", 
            "Winner": "du __toxico__"
        },

        "หมาป่าสีขาว" : {
            "title": "🐺 • หมาป่าสีขาวชนะ" , 
            "desc": "ในเกมนี้หมาป่าสีขาวเป็นผู้ชนะ.", 
        ...
        "ฆาตกร" : {
            "title": "🗡️• ฆาตกรชนะ" , 
            "desc": "ในเกมนี้ฆาตกรเป็นผู้ชนะ.", 
            "Winner": "de l'__assassin__"
        },

        "นางฟ้า" : {
            "title": "😇 • นางฟ้าชนะ" , 
            "desc": "ในเกมนี้นางฟ้าเป็นผู้ชนะ.", 
            "Winner": "de l'__ange__"
        },

        "นางฟ้าคนที่สอง" : {
            "title": "😇 • นางฟ้าคนที่สองชนะ" , 
            "desc": "หลังจากโหวตนางฟ้าก็ฆ่าตัวตายโดยเห็นว่าไม่มีคนตายในวันแรก นางฟ้าเป็นผู้ชนะเกมนี้.", 
            "Winner": "de l'__ange__"
        },

        "คนโง่" : {
            "title": "🃏 • คนโง่ชนะ" , 
            "desc": "ในเกมนี้คนโง่ชนะ.", 
            "Winner": "du __fou__"
        },

        "ซอมบี้" : {
            "title": "🧟‍♂️ • ซอมบี้ชนะ" , 
            "desc": "ในเกมนี้ซอมบี้เป็นผู้ชนะ.", 
            "Winner": "du __traqueur résurrecteur__"
        },
    },
    
    "ROLE_LG": {
        "เด็กป่า": {"name": "👦 • เด็กเร่ร่อน",
            "desc_village": "เด็กเร่ร่อนมีเวลา ** 30 ** วินาทีในการเลือกไอดอลของเขา.",
            "desc_channel": "คุณมีเวลา ** 30 ** วินาทีในการเลือกไอดอลของคุณ พิมพ์ชื่อผู้เล่นอื่น:\nxxx", //Don't edit "xxx" and don't place other "xxx"
            "role": "เด็กเร่ร่อน",
            "sleep": "เด็กเร่ร่อนได้หลับไปแล้ว."
        },
        "หมาเร่ร่อน": {"name": "🐶 • หมาเร่ร่อน",
            "villa": "หมาเร่ร่อนมีเวลา ** 30 ** วินาทีในการเลือกข้าง.",
            "chann": "คุณมี ** 30 ** วินาทีในการเลือกข้างของคุณ พิมพ์:\n🐺 Loup Garou \n🧒 Village.",
            "role" : "หมาเร่ร่อน",
            "sleep": "หมาเร่ร่อนได้เผลอหลับไป."
        },

        "กามเทพ": {"name": "💘 • กามเทพ",
            "villa": "กามเทพมีเวลา ** 30 ** วินาทีในการเลือกคนรักของเขา.",
            "chann": "เลือกคู่รักได้ตามต้องการจนถึงวันที่ 2 พิมพ์ชื่อผู้เล่นอื่น:\nxxx", //Don't edit "xxx" and don't place other "xxx"
            "role" : "กามเทพ",
            "sleep": "กามเทพได้หลับไปแล้ว."
        },

        "โจร": {"name": ":spy: • โจร",
            "villa": "หัวขโมยมีเวลา ** 30 ** วินาทีในการขโมยบทบาท.",
            "chann": "คุณมีเวลา 30 วินาทีในการแลกเปลี่ยนบทบาทกับผู้เล่นคนใดคนหนึ่ง พิมพ์ชื่อผู้เล่นอื่น:\nxxx", //Don't edit "xxx" and don't place other "xxx"
            "role" : "โจร",
            "sleep": "โจรได้หลับไปแล้ว."
        },

        "แฮ็กเกอร์": {"name": "💻 • แฮ็กเกอร์",
            "villa": "แฮ็กเกอร์มีเวลา ** 30 ** วินาทีในการเลือกว่าจะทำงานกลางคืนหรือกลางวัน.",
            "chann": "คุณมี ** 30 ** วินาทีในการเลือกว่าจะใช้เวลากลางคืนหรือกลางวัน \n🌕 Passer la nuit.\n🌞 Passer le jour.",
            "role" : "แฮ็กเกอร์",
            "sleep": "แฮ็กเกอร์ได้หลับไปแล้ว."
        },
